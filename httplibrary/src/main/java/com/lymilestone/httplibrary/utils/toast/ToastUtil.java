package com.lymilestone.httplibrary.utils.toast;
...
import com.lymilestone.httplibrary.R;
...
public class ToastUtil {
    ...
    public static void show(int resId) {
        show(AppManager.appContext().getString(resId));
    }

    public static void show(String msg) {
        if (td == null) {
            td = new ToastUtil(AppManager.appContext());
        }
        td.setText(msg);
        td.create().show();
    }
