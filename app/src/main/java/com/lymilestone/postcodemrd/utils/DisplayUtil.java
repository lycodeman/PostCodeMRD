...
public class DisplayUtil {
	...
	public static int px2dip(float pxValue) {
		final float scale = AppManager.appContext().getResources().getDisplayMetrics().density;
	...
	public static int px2sp(float pxValue) {
		final float fontScale = AppManager.appContext().getResources().getDisplayMetrics().scaledDensity;
